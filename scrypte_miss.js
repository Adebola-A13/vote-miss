...
const candidates = [
    ...
    { id: 15, name: "BIYAOU Fortunelle", photo:"images/Fortunelle.jpeg", description: "Une femme : une histoire ,des valeurs, une foi inébranlable. Ensemble, voyons plus loin que le reflet dans un miroir"}
];
